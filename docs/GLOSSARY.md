...
| Enforcement anchor | `#[shallguard::enforces]` or `shallguard::enforces_here!`, linking Rust behavior to a requirement. |
| Verification anchor | `#[shallguard::verifies]` on an enabled Rust test that provides evidence for a requirement. |
